...
namespace WPP.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            ViewBag.id = id;
            ViewBag.Status = db.Orders.Find(id).Status;
            return View(id);
        }
        ...
        {
            ViewBag.id = id;
            ViewBag.Discount = db.Orders.Find(id).Discount;
            return View(id);
        }

        [HttpPost, ActionName("ChangeDiscount")]
        public ActionResult ChangeDiscount(int id, int discount)
        {
            var order = db.Orders.Find(id);
